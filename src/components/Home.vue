  ...
  <v-layout row wrap>
    <v-flex xs4>
      <v-card>
        ...
        <v-card-text>
          It's been nearly two years since Superman's (Henry Cavill) battle with
          Zod (Michael Shannon) devastated the city of Metropolis. The loss of
          life and collateral damage left many feeling angry and helpless,
    ...
    <v-flex xs4>
      <v-card>
        ...
        <v-card-text>
          ...
          Hugh Glass (Leonardo DiCaprio) sustains life-threatening injuries from
